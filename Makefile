#############################################################################
# Makefile for building: When2Meet
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  When2Meet.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile When2Meet.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
DIST          = gui/When2Meet.pro.user \
		...
		gui/loginwindow.h \
		gui/mainwindow.h \
		include/Database.h gui/Account.cpp \
		gui/loginwindow.cpp \
		gui/main.cpp \
		gui/mainwindow.cpp \
		gui/loginwindow.cpp \
...
ui_loginwindow.h: gui/loginwindow.ui \
		/usr/lib/qt5/bin/uic
	/usr/lib/qt5/bin/uic gui/loginwindow.ui -o ui_loginwindow.h
...
install_target: first FORCE
	...
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/When2Meet/bin/$(QMAKE_TARGET)
